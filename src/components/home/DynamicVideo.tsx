...
function getEmbedUrl(url: string): string | null {
  try {
    ...
    if (u.hostname.includes("youtube.com") || u.hostname.includes("youtu.be")) {
      ...
      if (id) return `https://www.youtube-nocookie.com/embed/${id}?rel=0&modestbranding=1&autoplay=1&mute=1&loop=1&playlist=${id}&controls=0&disablekb=1&iv_load_policy=3`;
    }
